...
Begin VB.Form BantuHutang_frm 
   ...
   Begin MSDBGrid.DBGrid DBGrid2 
      Bindings        =   "BantuHutang_frm.frx":0000
      Height          =   3735
      Left            =   120
      OleObjectBlob   =   "BantuHutang_frm.frx":0014
      TabIndex        =   25
      Top             =   4080
      Width           =   9495
   End
   ...
   Begin VB.CommandButton Command2 
      ...
      DownPicture     =   "BantuHutang_frm.frx":09E7
      Height          =   735
      Left            =   3120
      MouseIcon       =   "BantuHutang_frm.frx":16B1
      MousePointer    =   99  'Custom
      Picture         =   "BantuHutang_frm.frx":19BB
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   120
      Width           =   1335
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H00C0C000&
      Caption         =   "TAMBAH"
      DownPicture     =   "BantuHutang_frm.frx":333D
      Height          =   735
      Index           =   0
      Left            =   120
      MouseIcon       =   "BantuHutang_frm.frx":4007
      MousePointer    =   99  'Custom
      Picture         =   "BantuHutang_frm.frx":4311
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   3240
      Width           =   1095
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H00C0C000&
      Caption         =   "EDIT"
      DownPicture     =   "BantuHutang_frm.frx":5C93
      Height          =   735
      Index           =   1
      Left            =   1200
      MouseIcon       =   "BantuHutang_frm.frx":695D
      MousePointer    =   99  'Custom
      Picture         =   "BantuHutang_frm.frx":6C67
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   3240
      Width           =   1095
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H00C0C000&
      Caption         =   "HAPUS"
      DownPicture     =   "BantuHutang_frm.frx":85E9
      Height          =   735
      Index           =   2
      Left            =   2280
      MouseIcon       =   "BantuHutang_frm.frx":92B3
      MousePointer    =   99  'Custom
      Picture         =   "BantuHutang_frm.frx":95BD
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3240
      Width           =   1095
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H00C0C000&
      Caption         =   "KELUAR"
      DownPicture     =   "BantuHutang_frm.frx":AF3F
      Height          =   735
      Index           =   3
      Left            =   3360
      MouseIcon       =   "BantuHutang_frm.frx":BC09
      MousePointer    =   99  'Custom
      Picture         =   "BantuHutang_frm.frx":BF13
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   3240
      Width           =   1095
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "BantuHutang_frm.frx":C67D
      Height          =   2895
      Left            =   4560
      OleObjectBlob   =   "BantuHutang_frm.frx":C691
      TabIndex        =   1
      Top             =   120
      Width           =   5175
   End
   ...
   End
End
Attribute VB_Name = "BantuHutang_frm"
...
Data1.RecordSource = "select nm_Hutang,saldo_awal,saldo_akhir,no_akun,bulan,tahun from bantuHutang where bulan = '" & Combo1 & "'"
Data1.Refresh
hit_jml
End Sub

Private Sub Combo2_Click()
Data1.RecordSource = "select nm_Hutang,saldo_awal,saldo_akhir,no_akun,bulan,tahun from bantuHutang where tahun = '" & Combo2 & "'"
Data1.Refresh
hit_jml
End Sub
...
Data1.RecordSource = "bantuHutang"
kosong
isi_cmb1
isi_cmb2
...
If Not .BOF Then
    .MoveFirst
    Do While Not .EOF
        If !no_akun = "2-110" And !bulan = Combo1 And !tahun = Combo2 Then
            .Edit
            !saldo_awal = a
            !saldo_akhir = b
            .Update
